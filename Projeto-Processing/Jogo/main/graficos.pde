PImage[] knight,knightAttack,knightJump,knightDead,knightRun;
int numberFrames = 10;
int i = 0,fps=0;
...
void personagem() {
  ...
  knightDead = new PImage [numberFrames];
  knightRun = new PImage [numberFrames];
  ...
  while(i<numberFrames){
      ...
      knightDead[i-1] = loadImage("freeknight/png/Dead ("+i+").png");
      knightRun[i-1] = loadImage("freeknight/png/Dead ("+i+").png");
